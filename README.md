...
since your api is running you may want real data to train or test your model
in order to extract and store that extrcated data of certain keywords like `smartphone / tshirt / shoes ...`

### HOW TO USE IT ?
1) Make sure you have `main.py` api hosted/running and having the same endpoints
2) Its necesary you have `product_url_collector.py` and `review_processor.py` at same place/dir as all 
3) Then run `start.py`
...
[Download 118,115 review dataset (washing machine)](https://drive.google.com/file/d/1TImf0qU_-2tDwEkM50S9ueLv1Fqa2yDa/view?usp=sharing)
